...
class AudioHandler(object):
    ...
    def get_file_lengths(list_wav_files):
        ...
        list_filepath_lengths = process_map(
            AudioHandler.soxi_get_length, list_wav_files
        )
    ...
    def slice_signal(signal, window_size, hop_size):
        ...
        window_indeces = np.array(
            [start_window + idx * hop_size for idx in range(num_windows)]
        )
